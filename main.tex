...
\begin{tabularx}{\linewidth}{lX}
    ...
    \textit{Minister} & \textbf{Wilt thou not turn again and quicken us;} \\
    \textit{All} & \textbf{that thy All may rejoice in thee?} \\
    & \\
    \textit{Minister} & \textbf{O Lord, show thy mercy upon us;} \\
    \textit{All} & \textbf{and grant us thy salvation.} \\
    & \\
    \textit{Minister} & \textbf{Vouchsafe, O Lord, to keep us this night without sin;} \\
    \textit{All} & \textbf{O Lord, have mercy upon us, have mercy upon us.} \\
    & \\
    \textit{Minister} & \textbf{O Lord, hear our prayer;} \\
...
\begin{tabularx}{\linewidth}{lX}
    ...
    \textit{Minister} & \textbf{We will lay us down in peace and take our rest.} \\
    \textit{All} & \textbf{For it is thou, Lord, only that makest us dwell in safety.} \\
    & \\
    \textit{Minister} & \textbf{The Lord be with you;} \\
    \textit{All} & \textbf{and with thy spirit.} \\
    & \\
    \textit{Minister} & \textbf{Let us bless the Lord.} \\
    \textit{All} & \textbf{Thanks be to God.} \\
    & \\
    \textit{Minister} & \textbf{The Almighty and merciful Lord,} \\
    & \textbf{the Father, the Son, and the Holy Ghost,} \\
    & \textbf{bless us and preserve us.} \\
    & \\
    \textit{All} & \textbf{Amen.}
...
\begin{tabularx}{\linewidth}{lX}
    ...
    mankind the rewards of everlasting life: grant, we beseech thee; that we mayh know 
    the succour of her intercession, thorugh whom we have been found worthy to 
